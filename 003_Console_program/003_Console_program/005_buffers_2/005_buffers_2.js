...
var bufData = buf1.toString('utf-8', 2, 4);
...
// при условии, что буфера, который сравниваются, имеют одинаковый индекс буфера, с которого была начата запись данных и одинаковые данные, метод  
// возвращает 0 если длина буферов одинакова, -1, если buf1 короче buf2 и 1, если наоборот 
